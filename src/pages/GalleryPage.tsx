    ...
    return (
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className="px-8 py-6 shrink-0">
                ...
                <p className="text-xs text-[#AAA] font-bold uppercase tracking-[0.2em] mt-1">Your Creations</p>
            </div>
            ...
            <div className="flex-1 p-8 pt-0 overflow-y-auto">
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-64 text-center">
                        <svg className="w-20 h-20 mb-4 text-[#1A1A2E]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <p className="text-[#BBB] font-bold text-sm uppercase tracking-widest mb-4">No Creations Yet</p>
                        <Link
                            to="/studio"
                        ...
                        {mediaItems.map((item) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="group relative aspect-[3/4] rounded-2xl overflow-hidden bg-gray-50 border border-black/[0.04] cursor-pointer hover:border-[#FF8FAB]/30 transition-all"
                                >
                                    {url ? (
                                        <>
                                            <img
                ...
                {!loading && totalCount > ITEMS_PER_PAGE && (
                    <div className="mt-8 flex items-center justify-center gap-6">
                        <button
                            ...
                            className="px-6 py-3 rounded-2xl glass text-[10px] font-bold uppercase tracking-widest hover:bg-black/[0.06] transition-all disabled:opacity-30 disabled:cursor-not-allowed"
                        >
                            ← Previous
                        </button>
                        <span className="text-[10px] text-[#AAA] uppercase tracking-widest">
