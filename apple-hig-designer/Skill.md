...
> **Exact values** from Apple's Figma Design Kit. Each style has specific letter-spacing — these are critical for matching Apple's visual feel.
...
:root {
  ...
  /* Font Size Scale with Line Height + Letter Spacing (from Figma) */
  --text-large-title: 34px; /* line-height: 41px, letter-spacing: +0.40px, weight: 400 (bold: 700) */
  --text-title1: 28px;      /* line-height: 34px, letter-spacing: +0.38px, weight: 400 (bold: 700) */
  --text-title2: 22px;      /* line-height: 28px, letter-spacing: -0.26px, weight: 400 (bold: 700) */
  --text-title3: 20px;      /* line-height: 25px, letter-spacing: -0.45px, weight: 400 (semibold: 600) */
  --text-headline: 17px;    /* line-height: 22px, letter-spacing: -0.43px, weight: 600 */
  --text-body: 17px;        /* line-height: 22px, letter-spacing: -0.43px, weight: 400 (semibold: 600) */
  --text-callout: 16px;     /* line-height: 21px, letter-spacing: -0.31px, weight: 400 (semibold: 600) */
  --text-subhead: 15px;     /* line-height: 20px, letter-spacing: -0.23px, weight: 400 (semibold: 600) */
  --text-footnote: 13px;    /* line-height: 18px, letter-spacing: -0.08px, weight: 400 (semibold: 600) */
  --text-caption1: 12px;    /* line-height: 16px, letter-spacing: 0px, weight: 400 (medium: 500) */
  --text-caption2: 11px;    /* line-height: 13px, letter-spacing: +0.06px, weight: 400 (semibold: 600) */
}
```
...
- **Always apply the correct letter-spacing** — this is what makes Apple typography feel "right"
- Use weight for hierarchy, not just size
- Headline is 600 weight by default (same size as Body but bolder)

### Color System

> **Source:** Extracted from Apple's official iOS/iPadOS Figma Design Kit. See `resources/figma-design-tokens.md` for complete reference with vibrant materials, fills, overlays, and liquid glass parameters.

```css
/* Apple System Colors - Light Mode (from Figma Design Kit) */
:root {
  /* System Colors */
  --system-red: #FF383C;
  ...
  /* Backgrounds (Grouped — for table views, grouped lists) */
  --bg-grouped-primary: #F2F2F7;
  --bg-grouped-secondary: #FFFFFF;
  --bg-grouped-tertiary: #F2F2F7;

  /* Fills (translucent overlays for UI elements) */
...
/* Dark Mode (from Figma Design Kit) */
...
### Liquid Glass (iOS 26+ - Only When Requested)

Apple's new material system with refraction, frost, and depth. Figma parameters: frost=6/20/35, depth=30/60, refraction=60.

```css
/* Liquid Glass - Regular (small controls, toolbar items) */
.liquid-glass {
...
/* Liquid Glass - Medium (sheets, sidebars) */
.liquid-glass-md {
...
/* Liquid Glass - Large (navigation bars, tab bars) */
.liquid-glass-lg {
...
**Skill Resource Files (loaded on demand):**
- `resources/figma-design-tokens.md` — **Complete extracted Apple design tokens** from official Figma Kit: all colors (light+dark), typography with exact letter-spacing, fills, backgrounds (standard+grouped+elevated), separators, vibrant materials, overlays, liquid glass parameters, component dimensions, and copy-paste CSS variables
- `resources/ui-patterns.md` — Full-page code examples: login, dashboard, product cards, pricing tables
- `REFERENCE.md` — Layout patterns, navigation, forms, data display, modals, empty/error/loading states, responsive breakpoints
...
*This skill uses actual values from Apple's official Figma iOS/iPadOS Design Kit (extracted via Lukasoppermann Design Tokens plugin), ensuring pixel-perfect accuracy with Apple's design system.*
